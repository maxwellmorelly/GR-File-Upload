# v4.7 — v4.3 Working Base + Editable UI
# ✅ Based on: v4.3 (proven stable with all fixes working)
# ✅ Working: Steam currency overrides (CZK→EUR, DKK→EUR, HUF→EUR, SEK→EUR)
# ✅ Working: PlayStation decimal fixes (JPY, KRW, CZK)
# ✅ Working: Xbox UAE currency (AED→USD)
# ✅ Working: Vanity pricing for all platforms
# ✅ Working: Battlefield 6 integration
# ✅ Added: Editable UI (add/edit/delete games per platform)
...
st.title("🎮 Game Pricing Tool — v4.7 Production")

st.markdown("""
### ✨ v4.7 Features:
- 📊 **Comprehensive Coverage**: 54 Steam markets, 47 Xbox markets, 41 PlayStation markets
- ✏️ **Fully Editable**: Add, edit, or delete games per platform with URLs and weights
- ✅ **All Fixes Working**: Steam EUR overrides, PS decimal fixes, Xbox currency fixes
...
# EDITABLE CONFIGURATION (like v4.4)
for platform in ['Steam', 'Xbox', 'PlayStation']:
