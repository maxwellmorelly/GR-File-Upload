# v4.6 — Production Complete: All Fixes from v4.2 Working Base
# ✅ Working: Steam pricing (270 points) - v4.2's proven logic
# ✅ Working: Full country names in recommendations - v4.2's approach  
# ✅ Added: Steam EUR currency overrides (HU/SE/CZ/DK)
# ✅ Added: PlayStation USD conversion fixes (JPY/KRW)
# ✅ Added: Vanity pricing
# ✅ Added: Battlefield 6 (replaces COD)
# ✅ Added: Enhanced Business Insights
import sys
...
st.title("🎮 Game Pricing Tool — v4.6 Production")
st.success("""
✨ **v4.6 Features**:
- 📊 Comprehensive Coverage: 54 Steam, 47 Xbox, 41 PlayStation markets
- ✅ Steam EUR Override: Hungary, Sweden, Czechia, Denmark show EUR
- ✅ PlayStation USD Fix: Japan/South Korea correct conversions
- ✅ Full Country Names: Recommendations show complete names (not codes)
- 💎 Vanity Pricing: Professional price rounding per market
- 🎯 Battlefield 6: Replaces Call of Duty in AAA tier
- 📈 Enhanced Strategy: Gray market risk, arbitrage, unit mix analysis
""")
...
if st.button("🚀 Pull Prices from All Markets", type="primary", use_container_width=True):
    ...
    if not ps_df.empty:
        ...
        # v4.6: Fix PlayStation decimal issues for whole number currencies
